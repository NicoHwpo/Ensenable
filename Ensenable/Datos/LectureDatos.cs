...
namespace Ensenable.Datos
{
    public class LectureDatos
    {
        ...
        public List<LectureModel> ListarLectures()
        {
            var oLista = new List<LectureModel>();

            var con = new Conexion();

            NpgsqlCommand com = new NpgsqlCommand("fn_listar_lectures", con.OpenCon());
        ...
        public bool CrearLecture(LectureModel oLecture)
        {
            ...
            string spcrearlec = "CALL sp_create_lecture (" + oLecture.IdCourse + ",'" + oLecture.NombreLecture + "','" + oLecture.YtLink + "','" + oLecture.Purpose + "','" + oLecture.PreguntasApoyo + "','" + oLecture.Texto + "')";
        ...
        public bool EditarDetalleLecture(LectureModel oLecture)
        {
            ...
            string editar = "CALL sp_modify_lecture (" + oLecture.IdLecture + "," + oLecture.IdCourse + ",'" + oLecture.NombreLecture + "','" + oLecture.YtLink + "','" + oLecture.Purpose + "','" + oLecture.PreguntasApoyo + "','" + oLecture.Texto + "')";
